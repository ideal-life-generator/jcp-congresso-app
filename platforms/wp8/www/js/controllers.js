...
(function() {
  ...
  atea.controller('RateController', [
    '$scope', '$location', 'baseURL', '$routeParams', 'connectionTest', '$filter', '$compile', 'message', 'getDataTest', '$http', function($scope, $location, baseURL, $routeParams, connectionTest, $filter, $compile, message, getDataTest, $http) {
          ...
          if (result.length) {
            return getDataTest.save({
              ...
              return getDataTest.put({
                ...
                var data;
                data = result.data;
                return message.success("You have received " + data.message.receivedTokens + " tokens!", function() {
  ...
  atea.controller('RatesController', [
    '$scope', '$location', 'baseURL', '$routeParams', 'connectionTest', 'message', function($scope, $location, baseURL, $routeParams, connectionTest, message) {
