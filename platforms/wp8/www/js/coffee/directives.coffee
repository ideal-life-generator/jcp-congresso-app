...
# 		string: [ 0, 1, 2, 3 ]
# 		margin: margin
# 		width: (6 - margin*length - margin) / length
# ]

# atea.directive 'lototron', [ 'lototron', (lototron) ->
# 	restrict: 'E'
# 	template: '<div class="lototron-wrap">
# 							<div class="loto">
# 								<div class="item"
# 										 ng-repeat="field in lototron.string"
# 										 style="width: ~lototron.width~em; height: ~lototron.width~em; margin-left: ~lototron.margin~em;">
# 									0
# 								</div>
# 							</div>
# 						 </div>'
